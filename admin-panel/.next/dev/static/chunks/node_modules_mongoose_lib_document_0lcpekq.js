...
"[project]/node_modules/mongoose/lib/document.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
/*!
 * Module dependencies.
 */ const DivergentArrayError = __turbopack_context__.r("[project]/node_modules/mongoose/lib/error/divergentArray.js [app-client] (ecmascript)");
...
const InternalCache = __turbopack_context__.r("[project]/node_modules/mongoose/lib/internal.js [app-client] (ecmascript)");
...
const MixedSchema = __turbopack_context__.r("[project]/node_modules/mongoose/lib/schema/mixed.js [app-client] (ecmascript)");
const ModifiedPathsSnapshot = __turbopack_context__.r("[project]/node_modules/mongoose/lib/modifiedPathsSnapshot.js [app-client] (ecmascript)");
...
const ParallelValidateError = __turbopack_context__.r("[project]/node_modules/mongoose/lib/error/parallelValidate.js [app-client] (ecmascript)");
...
const ValidatorError = __turbopack_context__.r("[project]/node_modules/mongoose/lib/error/validator.js [app-client] (ecmascript)");
const $__hasIncludedChildren = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/projection/hasIncludedChildren.js [app-client] (ecmascript)");
...
const compile = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/document/compile.js [app-client] (ecmascript)").compile;
...
const firstKey = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/firstKey.js [app-client] (ecmascript)");
const flatten = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/common.js [app-client] (ecmascript)").flatten;
const getEmbeddedDiscriminatorPath = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/document/getEmbeddedDiscriminatorPath.js [app-client] (ecmascript)");
const getKeysInSchemaOrder = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/schema/getKeysInSchemaOrder.js [app-client] (ecmascript)");
const getSubdocumentStrictValue = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/schema/getSubdocumentStrictValue.js [app-client] (ecmascript)");
...
const inspect = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/util/util.js [app-client] (ecmascript)").inspect;
...
const queryhelpers = __turbopack_context__.r("[project]/node_modules/mongoose/lib/queryHelpers.js [app-client] (ecmascript)");
...
const applyDefaultsBeforeSettersOptions = Object.freeze({
...
const documentModifiedPaths = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/symbols.js [app-client] (ecmascript)").documentModifiedPaths;
...
const getDeepestSubdocumentForPath = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/document/getDeepestSubdocumentForPath.js [app-client] (ecmascript)");
 ...
 */ Document.prototype.updateOne = function updateOne(update, options) {
    ...
    query.pre(async function queryPreUpdateOne() {
        const res = await self._execDocumentPreHooks('updateOne', options, [
            self,
            update,
            options
        ]);
 ...
 */ Document.prototype.$set = function $set(path, val, type, options) {
    ...
    if (path == null) {
        ...
        for(let i = 0, len = orderedKeys.length; i < len; ++i){
            (key = orderedKeys[i]) && Object.hasOwn(this._doc, key) && (orderedDoc[key] = undefined);
        }
    ...
    const priorVal = this.$__.priorDoc != null ? this.$__.priorDoc.$__getValue(path) : constructing ? void 0 : this.$__getValue(path);
    ...
    try {
        ...
        if (Array.isArray(val) && !Array.isArray(schema) && schema.$isMongooseDocumentArray && val.length !== 0 && val[0]?.$__?.populated != null) {
 ...
 */ Document.prototype.$__set = function(pathToMark, path, options, constructing, parts, schema, val, priorVal) {
    Embedded = Embedded || __turbopack_context__.r("[project]/node_modules/mongoose/lib/types/arraySubdocument.js [app-client] (ecmascript)");
    const shouldModify = this.$isNew && !options?._skipMarkModified ? true : this.$__shouldModify(pathToMark, path, options, constructing, parts, schema, val, priorVal);
    if (shouldModify) {
 ...
 */ Document.prototype.validate = async function validate(pathsToValidate, options) {
    ...
    try {
        ...
        const validated = {};
        const pathsToSave = Array.isArray(this.$__.saveOptions?.pathsToSave) ? new Set(this.$__.saveOptions.pathsToSave) : null;
        const promises = [];
        for(let i = 0; i < paths.length; ++i){
            ...
            promises.push(schemaType.doValidate(val, scope, doValidateOptions).then(()=>null, (err)=>{
 ...
 */ function _completeValidate(doc) {
    ...
    if (error) {
        for(const key in error.errors){
            ...
            if (!doc[documentArrayParent] && error.errors[key] instanceof MongooseError.CastError) {
...
const STATES_TO_VALIDATE = Object.freeze([
    'init',
    'default',
    'modify'
]);
 ...
 */ function _getPathsToValidate(doc, pathsToValidate, pathsToSkip, isNestedValidate) {
    ...
    for(let i = 0; i < STATES_TO_VALIDATE.length; ++i){
        ...
        for(const p in statePaths){
            ...
            if (_pathType) {
                if (!_pathType.schema && !_pathType.embeddedSchemaType && _pathType.validators.length === 0 && !_pathType.$parentSchemaDocArray && // gh-15957: skip this optimization for SchemaMap as maps can contain subdocuments
                // that need validation even if the map itself has no validators
                !_pathType.$isSchemaMap && !_pathType.$isSchemaUnion) {
                    continue;
...
function _addArrayPathsToValidate(doc, paths) {
    for (const path of paths){
        ...
        if (!_pathType.$isMongooseArray || !Array.isArray(_pathType) && _pathType.$isMongooseDocumentArray && !_pathType?.schemaOptions?.required) {
            continue;
        }
 ...
 */ Document.prototype._execDocumentPreHooks = function _execDocumentPreHooks(opName, options, argsForHooks) {
    ...
    return this.$__middleware.execPre(opName, this, argsForHooks || [], {
        filter
    });
};
/*!
 ...
 */ Document.prototype._execDocumentPostHooks = function _execDocumentPostHooks(opName, options, error) {
    ...
    return this.$__middleware.execPost(opName, this, [
        this
    ], {
        error,
        filter
 ...
 */ Document.prototype.$__reset = function reset(skipBackup, hasOnlyPrimitiveValues) {
    ...
    const subdocs = !this.$isSubdocument && !hasOnlyPrimitiveValues ? this.$getAllSubdocs({
        useCache: true
    }) : null;
    if (subdocs?.length > 0) {
 ...
 */ Document.prototype.$__getArrayPathsToValidate = function() {
    DocumentArray || (DocumentArray = __turbopack_context__.r("[project]/node_modules/mongoose/lib/types/documentArray/index.js [app-client] (ecmascript)"));
 ...
 */ function applyVirtuals(self, json, options, toObjectOptions) {
    ...
    let cur = self._doc;
    let v;
    const aliases = typeof toObjectOptions?.aliases === 'boolean' ? toObjectOptions.aliases : true;
    options = options || {};
 ...
 */ function applyGetters(self, json) {
    ...
    while(i--){
        ...
        if (path.indexOf('.') === -1) {
            json[path] = schemaType.applyGetters(json[path], self);
            if (Array.isArray(json[path]) && schemaType.embeddedSchemaType) {
                for(let i = 0; i < json[path].length; ++i){
                    json[path][i] = schemaType.embeddedSchemaType.applyGetters(json[path][i], self);
                }
            }
            continue;
        }
        ...
        for(let ii = 0; ii < plen; ++ii){
            ...
            if (branch != null && typeof branch !== 'object') {
                ...
                branch[part] = schemaType.applyGetters(branch[part], self);
                if (Array.isArray(branch[part]) && schemaType.embeddedSchemaType) {
                    for(let i = 0; i < branch[part].length; ++i){
                        branch[part][i] = schemaType.embeddedSchemaType.applyGetters(branch[part][i], self);
                    }
                }
            } else if (v == null) {
                if (part in cur) {
 ...
 */ Document.prototype.$__delta = function $__delta(pathsToSave, pathsToSaveSet) {
    ...
    for(; d < len; ++d){
        ...
        } else if (value[MongooseBuffer.pathSymbol] && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].isBuffer(value)) {
            // MongooseBuffer
 ...
 */ function operand(self, where, delta, data, val, op) {
    ...
    if (self.$__schema.options.optimisticConcurrency === true || Array.isArray(self.$__schema.options.optimisticConcurrency) || Array.isArray(self.$__schema.options.optimisticConcurrency?.exclude)) {
        return;
    }
    switch(op){
        case '$set':
...
//# sourceMappingURL=node_modules_mongoose_lib_document_0lcpekq.js.map