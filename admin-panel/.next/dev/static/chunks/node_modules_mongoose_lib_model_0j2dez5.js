...
"[project]/node_modules/mongoose/lib/model.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const DocumentNotFoundError = __turbopack_context__.r("[project]/node_modules/mongoose/lib/error/notFound.js [app-client] (ecmascript)");
...
const ObjectParameterError = __turbopack_context__.r("[project]/node_modules/mongoose/lib/error/objectParameter.js [app-client] (ecmascript)");
const OverwriteModelError = __turbopack_context__.r("[project]/node_modules/mongoose/lib/error/overwriteModel.js [app-client] (ecmascript)");
const Query = __turbopack_context__.r("[project]/node_modules/mongoose/lib/query.js [app-client] (ecmascript)");
const SaveOptions = __turbopack_context__.r("[project]/node_modules/mongoose/lib/options/saveOptions.js [app-client] (ecmascript)");
...
const VersionError = __turbopack_context__.r("[project]/node_modules/mongoose/lib/error/version.js [app-client] (ecmascript)");
const ParallelSaveError = __turbopack_context__.r("[project]/node_modules/mongoose/lib/error/parallelSave.js [app-client] (ecmascript)");
const applyDefaultsHelper = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/document/applyDefaults.js [app-client] (ecmascript)");
const isInPathsToSave = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/document/isInPathsToSave.js [app-client] (ecmascript)");
const applyDefaultsToPOJO = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/model/applyDefaultsToPOJO.js [app-client] (ecmascript)");
...
const applyHooks = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/model/applyHooks.js [app-client] (ecmascript)");
const applyMethods = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/model/applyMethods.js [app-client] (ecmascript)");
const applyProjection = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/projection/applyProjection.js [app-client] (ecmascript)");
const applyReadConcern = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/schema/applyReadConcern.js [app-client] (ecmascript)");
const applySchemaCollation = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/indexes/applySchemaCollation.js [app-client] (ecmascript)");
const applyStaticHooks = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/model/applyStaticHooks.js [app-client] (ecmascript)");
const applyStatics = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/model/applyStatics.js [app-client] (ecmascript)");
const applyTimestampsHelper = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/document/applyTimestamps.js [app-client] (ecmascript)");
const applyWriteConcern = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/schema/applyWriteConcern.js [app-client] (ecmascript)");
const applyVirtualsHelper = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/document/applyVirtuals.js [app-client] (ecmascript)");
const assignVals = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/populate/assignVals.js [app-client] (ecmascript)");
...
const convertErrorToStandardSchemaIssues = __turbopack_context__.r("[project]/node_modules/mongoose/lib/standardSchema/convertErrorToIssues.js [app-client] (ecmascript)");
...
const each = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/each.js [app-client] (ecmascript)");
...
const getModelsMapForPopulate = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/populate/getModelsMapForPopulate.js [app-client] (ecmascript)");
...
const isDefaultIdIndex = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/indexes/isDefaultIdIndex.js [app-client] (ecmascript)");
const isIndexEqual = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/indexes/isIndexEqual.js [app-client] (ecmascript)");
...
const isTimeseriesIndex = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/indexes/isTimeseriesIndex.js [app-client] (ecmascript)");
const { getRelatedDBIndexes, getRelatedSchemaIndexes } = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/indexes/getRelatedIndexes.js [app-client] (ecmascript)");
...
const parallelLimit = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/parallelLimit.js [app-client] (ecmascript)");
...
const pushNestedArrayPaths = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/model/pushNestedArrayPaths.js [app-client] (ecmascript)");
const removeDeselectedForeignField = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/populate/removeDeselectedForeignField.js [app-client] (ecmascript)");
...
const splitPopulateQuery = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/populate/splitPopulateQuery.js [app-client] (ecmascript)");
...
const minimize = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/minimize.js [app-client] (ecmascript)");
const MongooseBulkSaveIncompleteError = __turbopack_context__.r("[project]/node_modules/mongoose/lib/error/bulkSaveIncompleteError.js [app-client] (ecmascript)");
...
const { arrayAtomicsBackupSymbol, arrayAtomicsSymbol, modelSymbol } = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/symbols.js [app-client] (ecmascript)");
 ...
 */ Model.prototype.$__save = async function $__save(options) {
    try {
        ...
        const shouldValidateBeforeSave = hasValidateBeforeSaveOption ? !!options.validateBeforeSave : this.$__schema.options.validateBeforeSave;
        if (shouldValidateBeforeSave) {
            const hasValidateModifiedOnlyOption = options != null && typeof options === 'object' && Object.hasOwn(options, 'validateModifiedOnly');
 ...
 */ Model.prototype.deleteOne = function deleteOne(options) {
    ...
    query.pre(function callSubdocPreHooks() {
        return Promise.all(self.$getAllSubdocs().map((subdoc)=>subdoc.constructor._middleware.execPre('deleteOne', subdoc, [
                subdoc
            ], {
                filter: preFilter
            })));
    ...
    query.post(function callSubdocPostHooks() {
        return Promise.all(self.$getAllSubdocs().map((subdoc)=>subdoc.constructor._middleware.execPost('deleteOne', subdoc, [
                subdoc
            ], {
                filter: postFilter
            })));
    ...
    query.post(function queryPostDeleteOne() {
        return self.constructor._middleware.execPost('deleteOne', self, [
            self
        ], {
            filter: postFilter
        });
 ...
 */ Model.createCollection = async function createCollection(options) {
    ...
    [options] = await this.hooks.execPre('createCollection', this, [
        options
    ], {
        filter: preFilter
    }).catch((err)=>{
    ...
    try {
        ...
        if (err != null && (err.name !== 'MongoServerError' || err.code !== 48)) {
            await this.hooks.execPost('createCollection', this, [
                null
            ], {
                error: err,
                filter: postFilter
 ...
 */ Model.watch = function(pipeline, options) {
    ...
    options = options || {};
    const watchOptions = options?.hydrate !== undefined ? utils.omit(options, [
        'hydrate'
    ]) : {
        ...options
    };
    ...
    const changeStreamPromise = this.db._waitForConnect().then(()=>this.$__collection.watch(pipeline, watchOptions));
...
async function _insertMany(arr, options) {
    ...
    if (hasInsertManyHooks) {
        try {
            [arr] = await this._middleware.execPre('insertMany', this, [
                arr
            ], {
                filter: preFilter
            });
        } catch (error) {
            await this._middleware.execPost('insertMany', this, [
                arr
            ], {
                error,
                filter: postFilter
    ...
    if (hasInsertManyHooks) {
        const [result] = await this._middleware.execPost('insertMany', this, [
            docAttributes
        ], {
            filter: postFilter
        });
...
async function _bulkWrite(ops, options) {
    ...
    const postFilter = buildMiddlewareFilter(options, 'post');
    try {
        [ops, options] = await this.hooks.execPre('bulkWrite', this, [
            ops,
            options
        ], {
            filter: preFilter
        ...
        if (err instanceof Kareem.skipWrappedFunction) {
            ...
            await this.hooks.execPost('bulkWrite', this, [
                null
            ], {
                error: err,
                filter: postFilter
...
async function handleSuccessfulWrite(document, options) {
    ...
    const postFilter = buildMiddlewareFilter(options, 'post');
    return document.schema.s.hooks.execPost('save', document, [
        document
    ], {
        filter: postFilter
    });
 ...
 */ Model.hydrate = function hydrate(obj, projection, options) {
    ...
    const document = __turbopack_context__.r("[project]/node_modules/mongoose/lib/queryHelpers.js [app-client] (ecmascript)").createModel(this, obj, projection, projection, options);
    ...
    get () {
        return {
            ...
            validate: (value, options)=>{
                return this.validate(value, options?.libraryOptions).then((value)=>({
                        value
                    }), (error)=>({
                        issues: convertErrorToStandardSchemaIssues(error)
                    }));
            }
        };
    }
...
//# sourceMappingURL=node_modules_mongoose_lib_model_0j2dez5.js.map