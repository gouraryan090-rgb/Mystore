...
"[project]/node_modules/mongoose/lib/query.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const QueryCursor = __turbopack_context__.r("[project]/node_modules/mongoose/lib/cursor/queryCursor.js [app-client] (ecmascript)");
...
const castArrayFilters = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/update/castArrayFilters.js [app-client] (ecmascript)");
...
const isSubpath = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/projection/isSubpath.js [app-client] (ecmascript)");
const mpath = __turbopack_context__.r("[project]/node_modules/mpath/index.js [app-client] (ecmascript)");
const mquery = __turbopack_context__.r("[project]/node_modules/mquery/lib/mquery.js [app-client] (ecmascript)");
...
const removeUnusedArrayFilters = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/update/removeUnusedArrayFilters.js [app-client] (ecmascript)");
...
const sanitizeProjection = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/query/sanitizeProjection.js [app-client] (ecmascript)");
...
const selectPopulatedFields = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/query/selectPopulatedFields.js [app-client] (ecmascript)");
...
const updateValidators = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/updateValidators.js [app-client] (ecmascript)");
...
const queryMiddlewareFunctions = __turbopack_context__.r("[project]/node_modules/mongoose/lib/constants.js [app-client] (ecmascript)").queryMiddlewareFunctions;
 ...
 */ Query.prototype._find = async function _find() {
    ...
    if (this.options?._deferPopulate) {
        docs = mongooseOptions.lean ? docs : await this._completeMany(docs, fields, userProvidedFields, completeManyOptions);
 ...
 */ Query.prototype._findOneAndUpdate = async function _findOneAndUpdate() {
    ...
    this[queryUpdateSymbol] = setDefaultsOnInsert(this._conditions, this.model.schema, this[queryUpdateSymbol], options, this._mongooseOptions, this);
 ...
 */ function convertNewToReturnDocument(options) {
    if ('new' in options) {
        ...
        utils.warn('mongoose: the `new` option for `findOneAndUpdate()` and `findOneAndReplace()` is deprecated. ' + 'Use `returnDocument: ' + replacement + '` instead.');
        options.returnDocument = options['new'] ? 'after' : 'before';
        delete options['new'];
    }
    if ('returnOriginal' in options) {
        const replacement = options['returnOriginal'] ? '\'before\'' : '\'after\'';
        utils.warn('mongoose: the `returnOriginal` option for `findOneAndUpdate()` and `findOneAndReplace()` is deprecated. ' + 'Use `returnDocument: ' + replacement + '` instead.');
 ...
 */ Query.prototype._replaceOne = async function _replaceOne() {
    ...
    const options = this._optionsForExec(this.model);
    this[queryUpdateSymbol] = new this.model(this[queryUpdateSymbol], null, {
        skipId: true
    });
    removeUnusedArrayFilters(this[queryUpdateSymbol], options);
    if (_getOption(this, 'runValidators', false)) {
 ...
 */ async function _executePostHooks(query, res, error, op) {
    ...
    const [result] = await query._queryMiddleware.execPost(op || query.op, query, [
        res
    ], opts);
    return result;
}
...
//# sourceMappingURL=node_modules_mongoose_lib_query_1l06wso.js.map