  ...
  return (
    <div style={{ maxWidth: "1100px", margin: "32px auto", padding: "0 20px" }}>
      ...
      <form onSubmit={handleSubmit} style={{ backgroundColor: "#fff", padding: "24px", borderRadius: "12px", border: "1px solid #e5e7eb", marginBottom: "32px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", boxShadow: "0 1px 3px rgba(0,0,0,0.05)" }}>
        ...
        <input name="category" placeholder="Category" value={formData.category} onChange={handleChange} style={{ padding: "10px", borderRadius: "8px", border: "1px solid #d1d5db", fontSize: "14px", outline: "none" }} required />
        ...
        <input name="images" placeholder="Image URLs (Comma separated: url1, url2)" value={formData.images} onChange={handleChange} style={{ padding: "10px", borderRadius: "8px", border: "1px solid #d1d5db", fontSize: "14px", outline: "none", gridColumn: "span 2" }} required />
        <textarea name="description" placeholder="Description" value={formData.description} onChange={handleChange} style={{ padding: "10px", borderRadius: "8px", border: "1px solid #d1d5db", fontSize: "14px", outline: "none", gridColumn: "span 2", minHeight: "80px" }} required />
        ...
        {products.map((p) => (
          ...
          >
            <div>
              ...
              <p style={{ color: "#6b7280", fontSize: "13px", margin: "0 0 12px 0" }}>{p.category}</p>
        ...
        <div style={{ position: "fixed", top: 0, left: 0, width: "100vw", height: "100vh", backgroundColor: "rgba(0,0,0,0.5)", zIndex: 1000, display: "flex", alignItems: "center", justifyContent: "center", padding: "20px" }}>
          <div style={{ backgroundColor: "#fff", width: "100%", maxWidth: "600px", borderRadius: "16px", padding: "24px", position: "relative", maxHeight: "90vh", overflowY: "auto" }}>
            ...
            <form onSubmit={handleUpdateSubmit} style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
              ...
              <input name="category" value={editingProduct.category} onChange={(e) => setEditingProduct({ ...editingProduct, category: e.target.value })} style={{ padding: "10px", borderRadius: "8px", border: "1px solid #d1d5db" }} required />
              ...
              <input name="images" value={editingProduct.images} onChange={(e) => setEditingProduct({ ...editingProduct, images: e.target.value })} style={{ padding: "10px", borderRadius: "8px", border: "1px solid #d1d5db", gridColumn: "span 2" }} required />
              <textarea name="description" value={editingProduct.description} onChange={(e) => setEditingProduct({ ...editingProduct, description: e.target.value })} style={{ padding: "10px", borderRadius: "8px", border: "1px solid #d1d5db", gridColumn: "span 2", minHeight: "80px" }} required />
      ...
      {selectedProduct && !editingProduct && (
        <div style={{ position: "fixed", top: 0, left: 0, width: "100vw", height: "100vh", backgroundColor: "rgba(0,0,0,0.5)", zIndex: 1000, display: "flex", alignItems: "center", justifyContent: "center", padding: "20px" }}>
          <div style={{ backgroundColor: "#fff", width: "100%", maxWidth: "600px", borderRadius: "16px", padding: "24px", position: "relative", maxHeight: "90vh", overflowY: "auto" }}>
            ...
            <h2 style={{ fontSize: "20px", fontWeight: "bold", marginBottom: "8px" }}>{selectedProduct.title}[cite: 7]</h2>
            <p style={{ color: "#6b7280", fontSize: "14px", marginBottom: "16px" }}>{selectedProduct.description}[cite: 7]</p>
